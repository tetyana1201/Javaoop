...
public class StringsQuizActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_strings_quiz);
        ...
        if (user != null) {
            ...
            if (currentUserID.equals("Nd2M1lgHunVWFtq2Z7HFaqLdAzR2")) {
                ...
                Toast.makeText(StringsQuizActivity.this, "Ви не маєте прав доступу", Toast.LENGTH_SHORT).show();
                addButton.setVisibility(View.GONE);
            }
        } else {
            Toast.makeText(StringsQuizActivity.this, "Поточний користувач не знайдений", Toast.LENGTH_SHORT).show();
            addButton.setVisibility(View.GONE);
        }
    ...
    private void navigateToMainPage() {
        ...
        startActivity(new Intent(this, StringsActivity.class));
    }
}
