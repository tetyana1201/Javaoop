...
public class OperatorsPracticeActivity extends AppCompatActivity {
    ...
    private static final String TAG = "OperatorsPracticeActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_operators_practice);

        databaseReference = FirebaseDatabase.getInstance().getReference().child("operatorstests");
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectedOptionId == -1) {
                    Toast.makeText(OperatorsPracticeActivity.this, "Будь ласка, оберіть відповідь", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                if (selectedAnswer.equals(correctAnswer)) {
                    ...
                    Toast.makeText(OperatorsPracticeActivity.this, "Неправильна відповідь", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull com.google.firebase.database.DataSnapshot dataSnapshot) {
                ...
                if (!testList.isEmpty()) {
                    ...
                    Toast.makeText(OperatorsPracticeActivity.this, "Немає тестів у базі даних", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(OperatorsPracticeActivity.this, "Помилка завантаження тестів: " + databaseError.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    private void updateQuizStatusForCurrentUser() {
        ...
        if (currentUser != null) {
            ...
            DatabaseReference userRef = FirebaseDatabase.getInstance().getReference().child("operatorsresults").child(userId);
    ...
    private void saveTestResultsToFirebase(int correctAnswersCount, double scorePercentage) {
        DatabaseReference resultsRef = FirebaseDatabase.getInstance().getReference().child("operatorsresults");
