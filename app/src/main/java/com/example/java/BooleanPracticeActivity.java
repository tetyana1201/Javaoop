...
public class BooleanPracticeActivity extends AppCompatActivity {

    private static final String TAG = "BooleanPracticeActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_boolean_practice);

        databaseReference = FirebaseDatabase.getInstance().getReference().child("booleantests");
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectedOptionId == -1) {
                    Toast.makeText(BooleanPracticeActivity.this, "Будь ласка, оберіть відповідь", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                if (selectedAnswer.equals(correctAnswer)) {
                    ...
                    Toast.makeText(BooleanPracticeActivity.this, "Неправильна відповідь", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull com.google.firebase.database.DataSnapshot dataSnapshot) {
                ...
                if (!testList.isEmpty()) {
                    ...
                    Toast.makeText(BooleanPracticeActivity.this, "Немає тестів у базі даних", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(BooleanPracticeActivity.this, "Помилка завантаження тестів: " + databaseError.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    private void saveTestResultsToFirebase(int correctAnswersCount, double scorePercentage) {
        DatabaseReference resultsRef = FirebaseDatabase.getInstance().getReference().child("booleanresults");
