...
public class CondionalQuizActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_condional_quiz);
        ...
        if (user != null) {
            ...
            if (currentUserID.equals("Nd2M1lgHunVWFtq2Z7HFaqLdAzR2")) {
                ...
                Toast.makeText(CondionalQuizActivity.this, "Ви не маєте прав доступу", Toast.LENGTH_SHORT).show();
                addButton.setVisibility(View.GONE);
            }
        } else {
            Toast.makeText(CondionalQuizActivity.this, "Поточний користувач не знайдений", Toast.LENGTH_SHORT).show();
            addButton.setVisibility(View.GONE);
        }
            ...
            public void onClick(View v) {
                ...
                databaseReference.push().setValue(test, new DatabaseReference.CompletionListener() {
                    ...
                    public void onComplete(@NonNull DatabaseError error, @NonNull DatabaseReference ref) {
                        if (error == null) {
                            Toast.makeText(CondionalQuizActivity.this, "Тест успішно додано", Toast.LENGTH_SHORT).show();
                            // Перенаправлення на головну сторінку після успішного додавання
                            navigateToMainPage();
                        } else {
                            Toast.makeText(CondionalQuizActivity.this, "Не вдалося додати тест", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
