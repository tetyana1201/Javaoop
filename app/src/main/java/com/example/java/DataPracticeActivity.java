...
public class DataPracticeActivity extends AppCompatActivity {

    private static final String TAG = "DataPracticeActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_data_practice);

        databaseReference = FirebaseDatabase.getInstance().getReference().child("datatests");
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectedOptionId == -1) {
                    Toast.makeText(DataPracticeActivity.this, "Будь ласка, оберіть відповідь", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                if (selectedAnswer.equals(correctAnswer)) {
                    ...
                    Toast.makeText(DataPracticeActivity.this, "Неправильна відповідь", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull com.google.firebase.database.DataSnapshot dataSnapshot) {
                ...
                if (!testList.isEmpty()) {
                    ...
                    Toast.makeText(DataPracticeActivity.this, "Немає тестів у базі даних", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(DataPracticeActivity.this, "Помилка завантаження тестів: " + databaseError.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    private void saveTestResultsToFirebase(int correctAnswersCount, double scorePercentage) {
        DatabaseReference resultsRef = FirebaseDatabase.getInstance().getReference().child("dataresults");
