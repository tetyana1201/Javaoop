...
public class ArraysPracticeActivity extends AppCompatActivity {

    private static final String TAG = "ArraysPracticeActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_arrays_practice);

        databaseReference = FirebaseDatabase.getInstance().getReference().child("arraystests");
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectedOptionId == -1) {
                    Toast.makeText(ArraysPracticeActivity.this, "Будь ласка, оберіть відповідь", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                if (selectedAnswer.equals(correctAnswer)) {
                    ...
                    Toast.makeText(ArraysPracticeActivity.this, "Неправильна відповідь", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull com.google.firebase.database.DataSnapshot dataSnapshot) {
                ...
                if (!testList.isEmpty()) {
                    ...
                    Toast.makeText(ArraysPracticeActivity.this, "Немає тестів у базі даних", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(ArraysPracticeActivity.this, "Помилка завантаження тестів: " + databaseError.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    private void saveTestResultsToFirebase(int correctAnswersCount, double scorePercentage) {
        DatabaseReference resultsRef = FirebaseDatabase.getInstance().getReference().child("arraysresults");
